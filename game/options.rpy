...
init -1 python hide:
    ...
    config.window_title = u"Shirra's Ren'Py Battle Framework"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Shirra's Ren'Py Battle Framework"
    config.version = "0.4"
...
python early:
    config.save_directory = "PyBattleFramework-1419709820"
...
init python:
    ...
    build.directory_name = "PyBattleFramework_v0.4a1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "PyBattleFramework"
