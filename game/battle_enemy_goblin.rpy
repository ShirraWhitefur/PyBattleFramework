...
init -25:
    ...
    $ Goblin.Equipment_Weapon_Accuracy_Melee = 0
    $ Goblin.Equipment_Weapon_Accuracy_Ranged = 0
    $ Goblin.Equipment_Armor_Physical = 0
    $ Goblin.Equipment_Armor_Magic = 0
    $ Goblin.Equipment_Armor_Will = 0
    $ Goblin.Equipment_Weapon_Damage_Melee_Max = 5
    $ Goblin.Equipment_Weapon_Damage_Melee_Min = 1
    $ Goblin.Equipment_Weapon_Damage_Ranged_Max = 5
    $ Goblin.Equipment_Weapon_Damage_Ranged_Min = 1
    $ Goblin.Equipment_Weapon_Damage_Magic_Max = 2
    $ Goblin.Equipment_Weapon_Damage_Magic_Min = 1
    $ Goblin.Equipment_Weapon_Damage_Will_Max = 2
    $ Goblin.Equipment_Weapon_Damage_Will_Min = 1
