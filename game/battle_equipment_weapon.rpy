...
# Weapon - No Weapon Equipped - Bare Hands - no_weapon
    ...
    $ no_weapon.Equipment_Damage_Bonus_Melee = 0
    $ no_weapon.Equipment_Damage_Bonus_Ranged = 0
    $ no_weapon.Equipment_Damage_Bonus_Magic = 0
    $ no_weapon.Equipment_Damage_Bonus_Will = 0
...
# Weapon - Axe, Orcish - axe_orcish
    ...
    $ axe_orcish.Equipment_Damage_Bonus_Melee = 0
    $ axe_orcish.Equipment_Damage_Bonus_Ranged = 0
    $ axe_orcish.Equipment_Damage_Bonus_Magic = 0
    $ axe_orcish.Equipment_Damage_Bonus_Will = 0
...
# Weapon - Sword, Adventurer's - sword_adventurers
    ...
    $ sword_adventurers.Equipment_Damage_Bonus_Melee = 2
    $ sword_adventurers.Equipment_Damage_Bonus_Ranged = 0
    $ sword_adventurers.Equipment_Damage_Bonus_Magic = 0
    $ sword_adventurers.Equipment_Damage_Bonus_Will = 0
...
# Weapon - Bow, Short - bow_short
    ...
    $ bow_short.Equipment_Damage_Bonus_Melee = 0
    $ bow_short.Equipment_Damage_Bonus_Ranged = 10
    $ bow_short.Equipment_Damage_Bonus_Magic = 0
    $ bow_short.Equipment_Damage_Bonus_Will = 0
...
# Weapon - Wand of the Firemage - wand_firemage
    ...
    $ wand_firemage.Equipment_Damage_Bonus_Melee = 0
    $ wand_firemage.Equipment_Damage_Bonus_Ranged = 0
    $ wand_firemage.Equipment_Damage_Bonus_Magic = 10
    $ wand_firemage.Equipment_Damage_Bonus_Will = 0
