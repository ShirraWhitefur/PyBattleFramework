...
# LowerBodyArmor - No Armor Equipped - no_lower_armor
    ...
    $ no_lower_armor.Equipment_Damage_Bonus_Melee_Max = 0
    $ no_lower_armor.Equipment_Damage_Bonus_Ranged_Max = 0
    $ no_lower_armor.Equipment_Damage_Bonus_Magic_Max = 0
...
# LowerBodyArmor - Ragged Leather Armor - lower_leather_rags
    ...
    $ lower_leather_rags.Equipment_Damage_Bonus_Melee_Max = 0
    $ lower_leather_rags.Equipment_Damage_Bonus_Ranged_Max = 0
    $ lower_leather_rags.Equipment_Damage_Bonus_Magic_Max = 0
    $ lower_leather_rags.Equipment_Damage_Bonus_Will_Max = 0
...
# LowerBodyArmor - Chainmail Leggings - lower_chain_armor
    ...
    $ lower_chain_armor.Equipment_Damage_Bonus_Melee_Max = 0
    $ lower_chain_armor.Equipment_Damage_Bonus_Ranged_Max = 0
    $ lower_chain_armor.Equipment_Damage_Bonus_Magic_Max = 0
    $ lower_chain_armor.Equipment_Damage_Bonus_Will_Max = 0
